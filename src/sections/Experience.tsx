...
export default function ExperiencePreview() {
  return <section className="section editorial-section"><div className="content-width"><SectionLabel>02 / Experience</SectionLabel><h2 className="section-title">Experience</h2>
    ...
    <div className="hero-intro__actions"><CTAButton href="/experience">View Full Experience</CTAButton><CTAButton href={profile.resume} download="Joaquin Elizalde Resume.pdf">Download Resume</CTAButton></div>
  </div></section>;
}
